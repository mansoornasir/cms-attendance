...
1. **Install dependencies:**
   ...
   After installing NodeJS, navigate to the attendance directory and 
   run the following commands inside the attendance directory 
   Note: (this needs to be done one time only)
